            ...
            <p className="text-[#9AA7BD]">
              {error === "Item not found"
                ...
                : error === "Item expired"
                  ...
                  : error ||
                    "Something went wrong while loading this clipboard item."}
            </p>
            <Button
              onClick={() => navigate("/")}
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  {item.kind === "file" ? (
                    isImage ? (
                      <Image className="w-5 h-5 text-[#20C15A]" />
                    ) : (
                      <File className="w-5 h-5 text-[#20C15A]" />
                    )
                  ) : (
              ...
              <div className="space-y-4">
                {isExpired ? (
                  <div className="flex items-center justify-center min-h-[200px]">
                    <div className="bg-[#131A26]/90 border border-[#273244] rounded-xl px-6 py-3">
                      <div className="text-[#E85B5B] font-medium">
                        Content Expired
                      </div>
                      <div className="text-sm text-[#9AA7BD]">
                      ...
                      <div>
                        {isImage ? (
                          ...
                          <div className="bg-[#0B0F1A] border border-[#273244] rounded-xl p-6 text-center">
                            ...
                            <div className="text-[#E6EAF2] font-medium mb-2">
                              {item.fileName}
                            </div>
                ...
                {!isExpired && (
                  <div className="flex gap-2">
                    <Input
                      value={`https://copypal.usecases.arkiv.network/c/${id}`}
                      readOnly
                    ...
                    <Button
                      onClick={() => {
                        navigator.clipboard?.writeText(
                          `https://copypal.usecases.arkiv.network/c/${id}`,
                        );
                      }}
                      variant="secondary"
